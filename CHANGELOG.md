...
## [2.2.1](https://github.com/3xyz7/better-moodle/compare/2.10.0...2.2.1) (2026-08-09)


### Features

* **config:** add support for HSNR Moodle instance ([#1164](https://github.com/3xyz7/better-moodle/issues/1164)) ([f0c4fe4](https://github.com/3xyz7/better-moodle/commit/f0c4fe4ac047759923026426cbebc7bc09fc281a))
* **courses:** close image zooming on pressing ESC ([bd82ee1](https://github.com/3xyz7/better-moodle/commit/bd82ee1bb46aaa9d9214797680f749cc3b53c9a1))
* **courses:** implpement transition for closing zoomed images ([5882d03](https://github.com/3xyz7/better-moodle/commit/5882d034051030f9ea6bcb4bc33a756819fb630d))
* **courses:** re-introduce sidebarCollapseAll ([ac98a6b](https://github.com/3xyz7/better-moodle/commit/ac98a6b85a165d94e56352ec2ce491c878a599bb))
* **dashboard:** add course actions to sidebar [#830](https://github.com/3xyz7/better-moodle/issues/830) ([adff056](https://github.com/3xyz7/better-moodle/commit/adff0566e42afcff3b11dfd8f37595646ae6872f))
* **deps:** upgrade vite to v8 ([#1065](https://github.com/3xyz7/better-moodle/issues/1065)) ([666b8ca](https://github.com/3xyz7/better-moodle/commit/666b8ca2e9779aadfc8371e0e7a92b05aeb7766a))
* **images:** use a higher resolution version when zooming into profile pictures ([e42de90](https://github.com/3xyz7/better-moodle/commit/e42de909c5a13018142edc408063b77324e8a6f5))
* **images:** zoom images will now enlarge tinyicon preview images ([#1080](https://github.com/3xyz7/better-moodle/issues/1080)) ([1667198](https://github.com/3xyz7/better-moodle/commit/1667198d66458d5eb1a00315149bfcd650fe42b4))
* implement a system for nightly builds [#1072](https://github.com/3xyz7/better-moodle/issues/1072) ([#1077](https://github.com/3xyz7/better-moodle/issues/1077)) ([6bdd8b1](https://github.com/3xyz7/better-moodle/commit/6bdd8b12c32a8c74e38a52d36f05389acfb6f9e9))
* implement short christmas countdown [#822](https://github.com/3xyz7/better-moodle/issues/822) ([18569df](https://github.com/3xyz7/better-moodle/commit/18569df4ad01fd6e63028077586f927ff30f2c2e))
* **linkIcons:** add mattermost icon to wetalk.informatik.uni-kiel.de links (CAU-only) ([#872](https://github.com/3xyz7/better-moodle/issues/872)) ([dfae698](https://github.com/3xyz7/better-moodle/commit/dfae6982e3479d372f5a09d32901549f802d7f0f))
* **linkIcons:** implement linkIcons for Webex (UzL-only) ([93ac707](https://github.com/3xyz7/better-moodle/commit/93ac7078e87cb58d6524d6576350b8cc22274db9))
* **navbarDropdown:** allow accessing sections and activities ([#1148](https://github.com/3xyz7/better-moodle/issues/1148)) ([74c049c](https://github.com/3xyz7/better-moodle/commit/74c049cc2c045b7082b5a91894d70a267877000c))
* **nina:** show start and end date in summary ([4503525](https://github.com/3xyz7/better-moodle/commit/45035258e95a4a87edde4edadeab5436618c4010))
* **nina:** show time of start and end [#803](https://github.com/3xyz7/better-moodle/issues/803) ([d8a16ff](https://github.com/3xyz7/better-moodle/commit/d8a16ffcd7e815e7e31f847ad0676af7ac95abb6))
* **sectionCourseIndex:** allow sectionCourseIndex to work on pages other than the courses main page ([#1154](https://github.com/3xyz7/better-moodle/issues/1154)) ([df524ea](https://github.com/3xyz7/better-moodle/commit/df524ea769efedf500dc5082e6acba63aebab102))
* **semesterzeiten:** include advertised events in semesterzeiten ([64477db](https://github.com/3xyz7/better-moodle/commit/64477dbec5b4826a30f67df241e0304219bb882c))
* **speiseplan:** implement filters [#859](https://github.com/3xyz7/better-moodle/issues/859) ([#882](https://github.com/3xyz7/better-moodle/issues/882)) ([b16ad90](https://github.com/3xyz7/better-moodle/commit/b16ad90ab06126d8c53aa6f15a268f09b8e45d2b))
* **style:** improve creating style elements at diverse points ([c4f697b](https://github.com/3xyz7/better-moodle/commit/c4f697bc3bc45782e0ca99c45aaaa9aa4a3e1be9))


### Bug Fixes

* **bookmarks:** improve cursor of disabled buttons ([d7d86ff](https://github.com/3xyz7/better-moodle/commit/d7d86ff412e07a1c28e7bc607b23203cd71876eb))
* **bookmarks:** improve position of add-button ([a3f746a](https://github.com/3xyz7/better-moodle/commit/a3f746a15ceeb2e41c1fe24e4bf889e892c9dd3c))
* **cauNavbar:** make buttons translateable by removing the weird icon hacks ([#871](https://github.com/3xyz7/better-moodle/issues/871)) ([43cda83](https://github.com/3xyz7/better-moodle/commit/43cda832c61a343b8bbe237cc072288cb18b0e4c))
* **courses/images:** don't apply maxWidth on drag and drop question images ([#964](https://github.com/3xyz7/better-moodle/issues/964)) ([c02e97f](https://github.com/3xyz7/better-moodle/commit/c02e97f6aa02066a93439007a5b081c962fecd34)), closes [#963](https://github.com/3xyz7/better-moodle/issues/963)
* **courses:** fix zooming into svg images ([975e7fc](https://github.com/3xyz7/better-moodle/commit/975e7fc4d15e3515873b701ceebf729ccdb833e3))
* **courses:** fix zooming onto images with css width set ([fc6664d](https://github.com/3xyz7/better-moodle/commit/fc6664d07d36aad3998572a3008404a31918f5be))
* **darkmode:** make availability-icons visible ([3ef8e49](https://github.com/3xyz7/better-moodle/commit/3ef8e4946adf85a40ee69eb99a8a09c0d8718902))
* **drawers:** do not show multiple buttons on same position ([42cd6c1](https://github.com/3xyz7/better-moodle/commit/42cd6c1350d949cd0b8e726a85465d4f5725c016))
* **drawers:** fix drawer toggle positions ([aafcc8f](https://github.com/3xyz7/better-moodle/commit/aafcc8f93bfb5837da6a86b38787cfdf00cd6d6d))
* **drawers:** fix tooltips on buttons for opening ([7a33fa6](https://github.com/3xyz7/better-moodle/commit/7a33fa604dcabba0d2aad72d0bb1ef107fc9a383))
* **drawers:** fix tooltips on moodle &gt;= 500 ([8dfc447](https://github.com/3xyz7/better-moodle/commit/8dfc447abe91d3b3e9caa98afa447a8a669401b0))
* **events:** do not show a time if time is not necessary ([8703e8b](https://github.com/3xyz7/better-moodle/commit/8703e8ba967a2fe8bdc359188b46e65f38d36df2))
* **hsnr:** swap login JPG logo to SVG and set default pride logo rotation to 135° ([#1174](https://github.com/3xyz7/better-moodle/issues/1174)) ([0d6a13e](https://github.com/3xyz7/better-moodle/commit/0d6a13e3e3095b8a4c4c3f4e746395142162e769))
* **images:** avoid stretched images when zooming ([034257d](https://github.com/3xyz7/better-moodle/commit/034257dedcf12bfd1a39a0b80f2c186b43be9727))
* **images:** do not zoom images in buttons ([8792f5e](https://github.com/3xyz7/better-moodle/commit/8792f5e2dd17752bb3c0b2ce02ed54ce268e8487))
* **images:** do not zoom on availability icons ([e3990e0](https://github.com/3xyz7/better-moodle/commit/e3990e03f1f57b6e3cfd868fde9f2dd95d8d3417))
* **images:** fix some full-width images from overflowing ([4b30282](https://github.com/3xyz7/better-moodle/commit/4b30282cb1e9a3f03518f50e8c5542e441408007))
* **images:** remove max-width and max-height from copied image style ([#942](https://github.com/3xyz7/better-moodle/issues/942)) ([c9493b7](https://github.com/3xyz7/better-moodle/commit/c9493b7bf9ca3469361c94253f4f1506901fc8a6))
* **linkIcons:** do not show icon on de-facto empty links ([959e437](https://github.com/3xyz7/better-moodle/commit/959e437e0cd9b12e2adf28c2d076ef6f92bfc35b))
* **linkIcons:** fix padding for icons after the text ([9ec1cd5](https://github.com/3xyz7/better-moodle/commit/9ec1cd546877ea136dbf2054147c653adeb78333))
* make use of mathjaxloader helper in &gt;= 500 ([a5bcc1b](https://github.com/3xyz7/better-moodle/commit/a5bcc1b25611475a2106e068041c20cc544bd470))
* **marquee:** fix events sometimes not clickable [#884](https://github.com/3xyz7/better-moodle/issues/884) ([2477407](https://github.com/3xyz7/better-moodle/commit/2477407b452db3698aeeea8bf8b05b146c3babc7))
* **modals:** fix some modals taking long to load ([f218809](https://github.com/3xyz7/better-moodle/commit/f2188098b92d05f3eb45c6091863579b9cf211b7))
* **modals:** fix visual glitches in some Better-Moodle modals ([c493e3a](https://github.com/3xyz7/better-moodle/commit/c493e3ac93316c86c3372f2a52e6af71965dd78a))
* **moodle:** avoid onpage jumps when switching language ([16b3214](https://github.com/3xyz7/better-moodle/commit/16b32143a4b8b0ab9700951d90826c426414c37f))
* **nina:** fix accessibility of more info links ([52d07cf](https://github.com/3xyz7/better-moodle/commit/52d07cf6c8d9bb1bc029748753528ef37244bd71))
* **nina:** fix tooltips on moodle &gt;= 500 ([82b5c8d](https://github.com/3xyz7/better-moodle/commit/82b5c8d6a24c59ff0fa4a0729229d8eb02515d62))
* **nina:** make use of warnung.bund.de as bund.dev shut down their proxy ([c5101ba](https://github.com/3xyz7/better-moodle/commit/c5101bac2ca3a7b367f0aefa6b2faa8972ff5e25))
* **nina:** mark seen alerts as seen without reopening summary modal ([dbc5cb2](https://github.com/3xyz7/better-moodle/commit/dbc5cb273ca4d0387e160ab59c9ec8077d8342d7))
* **nina:** show location in alert summary ([d2faa64](https://github.com/3xyz7/better-moodle/commit/d2faa64c6cd2bfa58d3ad5b0c0ed756b5cef4862))
* **sectionCourseIndex:** fix empty links when feature is disabled ([#1153](https://github.com/3xyz7/better-moodle/issues/1153)) ([106cdb2](https://github.com/3xyz7/better-moodle/commit/106cdb22c7baea00802868a4df9e827a6aa0f22a))
* **semesterzeiten:** do not include events after end of semester ([395a38e](https://github.com/3xyz7/better-moodle/commit/395a38e566708a5697741e175a09ce5ab4e49a04))
* **semesterzeiten:** do not include events before begin of semester ([23c8638](https://github.com/3xyz7/better-moodle/commit/23c863831078e46d6b0fd12713951710b71c4377))
* **semesterzeiten:** do not show weird descriptions in event modals ([8b4e4a9](https://github.com/3xyz7/better-moodle/commit/8b4e4a955a60817287b4091bdf78918e67a53b61))
* **semesterzeiten:** fix tooltips on moodle &gt;= 500 ([0bfe7f9](https://github.com/3xyz7/better-moodle/commit/0bfe7f92abbebd04a96adc462da51f6cef01adef))
* set correct cursor for sliders ([efc477e](https://github.com/3xyz7/better-moodle/commit/efc477ea7a0d5eeb071221f10086e841073685e6))
* **settings:** do not trigger channel modal on cancel ([3f88a82](https://github.com/3xyz7/better-moodle/commit/3f88a824c8c659a799fb29d01471bd008dd1e258))
* **settings:** enhance compatibility with moodle 502 ([281439d](https://github.com/3xyz7/better-moodle/commit/281439d6e90a41ea35a9248a3d84b153ce5d1360))
* **settings:** fix syncing some settings such as darkmode ([c42df5d](https://github.com/3xyz7/better-moodle/commit/c42df5d23858de5a1ac957e4ee3d2ee56a6882d3))
* **settings:** make latest version be aligned to end ([089d910](https://github.com/3xyz7/better-moodle/commit/089d910ccc80d7ce65165361188e420a3f71ada5))
* **speiseplan:** add a darkmode fix for the 'your-favourites' logo ([#817](https://github.com/3xyz7/better-moodle/issues/817)) ([3ef7aeb](https://github.com/3xyz7/better-moodle/commit/3ef7aeb643ddcf7271fa108aa40adf93bfac9a0a))
* **speiseplan:** disable speiseplan settings if speiseplan is disabled ([87ad4c1](https://github.com/3xyz7/better-moodle/commit/87ad4c18216462980f30400c731ec101e61fa857))
* **speiseplan:** fix co2-score ([542909c](https://github.com/3xyz7/better-moodle/commit/542909cc608b4611fb0be57f9e7b26a8180c68ac))
* **speiseplan:** fix english canteen menu not working ([#818](https://github.com/3xyz7/better-moodle/issues/818)) ([32c675f](https://github.com/3xyz7/better-moodle/commit/32c675f8c5fbd19212fa505924d601b7946efc0c))
* **speiseplan:** fix tooltips on moodle &gt;= 500 ([4b0a520](https://github.com/3xyz7/better-moodle/commit/4b0a52068aa029692bb3bf2ddd211acf196e1d1e))
* **speiseplan:** next day sometimes beeing hidden when there is no menu for the current day ([#845](https://github.com/3xyz7/better-moodle/issues/845)) ([0446cf8](https://github.com/3xyz7/better-moodle/commit/0446cf802bae5562a5891a8b53ce4cfc0d72a95d)), closes [#821](https://github.com/3xyz7/better-moodle/issues/821)
* **speiseplan:** show alternative info if speiseplan is empty ([16b1c0e](https://github.com/3xyz7/better-moodle/commit/16b1c0e64044c0c334b6a51415e671a4ef951f3c))
* **uzl:** fix evaluationsende should be 31.03 ([80a1726](https://github.com/3xyz7/better-moodle/commit/80a1726ed31404f449aafc6f750fc67fc7365cb2))
* **uzl:** set end of evaluationszeitraum to 05.07 ([c17be1f](https://github.com/3xyz7/better-moodle/commit/c17be1fbdce490085f7156bfea1a968054e580e3))
* **weather:** do not crash with wttr.in missing localObsDateTime [#1160](https://github.com/3xyz7/better-moodle/issues/1160) ([0fe391b](https://github.com/3xyz7/better-moodle/commit/0fe391b74597be2e7764fb906269bf1fa205cba1))
* **weather:** make tooltip work on moodle 502 ([71ca45a](https://github.com/3xyz7/better-moodle/commit/71ca45a0402953324233cd94c201ea7a3456b92a))
* **weather:** make wttr.in work again ([4b5f339](https://github.com/3xyz7/better-moodle/commit/4b5f3399e4e43156f402abff06b74b5192b2806e))


### Performance Improvements

* Run userscript at document-start to improve startup time ([#968](https://github.com/3xyz7/better-moodle/issues/968)) ([4a6c2f1](https://github.com/3xyz7/better-moodle/commit/4a6c2f15d971b3637106b3620aabfec088a70091))


### Miscellaneous Chores

* **cau:** update to Moodle 4.5 ([#840](https://github.com/3xyz7/better-moodle/issues/840)) ([20b6615](https://github.com/3xyz7/better-moodle/commit/20b6615ba9112ea60f7bbaa3bf88e027e798cbe6))
